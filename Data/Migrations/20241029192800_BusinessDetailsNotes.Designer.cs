...
namespace Mantis.Migrations
{
    ...
    [Migration("20241029192800_BusinessDetailsNotes")]
    partial class BusinessDetailsNotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mantis.Domain.Attachments.Models.Attachment", b =>
                {
            ...
            modelBuilder.Entity("Mantis.Domain.Attachments.Models.AttachmentGroup", b =>
                {
                    b.Property<int>("AttachmentGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mantis.Domain.Attachments.Models.Folder", b =>
                {
                    b.Property<int>("FolderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mantis.Domain.Carriers.Models.Credential", b =>
                {
            ...
            modelBuilder.Entity("Mantis.Domain.Clients.Models.BusinessDetails", b =>
                {
                    ...
                    b.Property<bool?>("HqMonitoredSecurity")
                        .HasColumnType("bit");

                    b.Property<int?>("HqNumberOfStories")
                        .HasColumnType("int");

                    b.Property<bool?>("HqSprinklered")
                        .HasColumnType("bit");

                    b.Property<int?>("HqSquareFootage")
                        .HasColumnType("int");

                    b.Property<int?>("HqYearBuilt")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mantis.Domain.Clients.Models.ClientNote", b =>
                {
            ...
            modelBuilder.Entity("Mantis.Domain.Clients.Models.Lead", b =>
                {
            ...
            modelBuilder.Entity("Mantis.Domain.Clients.Models.LeadNote", b =>
                {
            ...
            modelBuilder.Entity("Mantis.Domain.Logs.Log", b =>
                {
            ...
            modelBuilder.Entity("Mantis.Domain.Renewals.Models.SubmissionNote", b =>
                {
                    b.Property<int>("SubmissionNoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SubmissionNoteId"));
            ...
            modelBuilder.Entity("Mantis.Domain.Shared.Models.FireSearchResultViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mantis.Domain.Attachments.Models.Attachment", b =>
                {
                    b.HasOne("Mantis.Domain.Attachments.Models.AttachmentGroup", "AttachmentGroup")
                    ...
                    b.HasOne("Mantis.Domain.Attachments.Models.Folder", "Folder")
                        .WithMany("Attachments")
                    ...
                    b.HasOne("Mantis.Data.ApplicationUser", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Mantis.Domain.Clients.Models.LeadNote", b =>
                {
                    b.HasOne("Mantis.Domain.Clients.Models.Lead", "Lead")
                        .WithMany("LeadNotes")
            ...
            modelBuilder.Entity("Mantis.Domain.Logs.Log", b =>
                {
                    b.HasOne("Mantis.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Mantis.Domain.Policies.Models.AutoCoverage", b =>
                {
                    b.HasOne("Mantis.Domain.Attachments.Models.Attachment", "AdditionalAttachmentsAttachment")
                        .WithMany()
                        .HasForeignKey("AdditionalAttachmentsAttachmentAttachmentId");

                    b.HasOne("Mantis.Domain.Attachments.Models.Attachment", "AdditionalInsuredAttachment")
                        .WithMany()
                    ...
                    b.HasOne("Mantis.Domain.Attachments.Models.Attachment", "WaiverOfSubAttachment")
                        .WithMany()
            ...
            modelBuilder.Entity("Mantis.Domain.Renewals.Models.SubmissionNote", b =>
                {
                    b.HasOne("Mantis.Domain.Renewals.Models.Submission", "Submission")
