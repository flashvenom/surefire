"""
Alternate method of renameing all form fields on a form-field enabled PDF so that you can start fresh knowing there are no duplicates or wonky characters
"""
