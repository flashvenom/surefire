...
public partial class ApplicationDbContext
{
    partial void ConfigureColumnProperties(ModelBuilder modelBuilder)
    {
        if (Database.IsSqlite())
        {
            ...
            // RenewalUpdate large text columns - use TEXT for SQLite
            modelBuilder.Entity<RenewalUpdate>()
                .Property(r => r.JsonData)
                .HasColumnType("TEXT");
            modelBuilder.Entity<RenewalUpdate>()
                .Property(r => r.OriginalJsonData)
                .HasColumnType("TEXT");
            modelBuilder.Entity<RenewalUpdate>()
                .Property(r => r.NotesForClient)
                .HasColumnType("TEXT");
            modelBuilder.Entity<RenewalUpdate>()
                .Property(r => r.NotesForStaff)
                .HasColumnType("TEXT");
            modelBuilder.Entity<RenewalUpdate>()
                .Property(r => r.NotesFromClient)
                .HasColumnType("TEXT");
        }
        else
        {
            ...
            // RenewalUpdate large text columns
            modelBuilder.Entity<RenewalUpdate>()
                .Property(r => r.JsonData)
            ...
            //Indexes
            modelBuilder.Entity<EntityAssociation>(entity =>
            {
