...
namespace Surefire.Migrations
{
    ...
    [Migration("20241025003656_AttachmentContextUpdate")]
    partial class AttachmentContextUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Address", b =>
                {
                    b.Property<int>("AddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.DailyTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Driver", b =>
                {
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Models.Attachment", b =>
                {
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Models.AttachmentGroup", b =>
                {
                    b.Property<int>("AttachmentGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Models.Folder", b =>
                {
                    b.Property<int>("FolderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Vehicle", b =>
                {
            ...
            modelBuilder.Entity("Surefire.Domain.Carriers.Models.Carrier", b =>
                {
                    b.HasOne("Surefire.Domain.Shared.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("Surefire.Domain.Clients.Models.Lead", b =>
                {
                    ...
                    b.HasOne("Surefire.Domain.Shared.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Surefire.Domain.Policies.Models.AutoCoverage", b =>
                {
                    b.HasOne("Surefire.Domain.Shared.Models.Attachment", "AdditionalAttachmentsAttachment")
                        .WithMany()
                        .HasForeignKey("AdditionalAttachmentsAttachmentAttachmentId");

                    b.HasOne("Surefire.Domain.Shared.Models.Attachment", "AdditionalInsuredAttachment")
                        .WithMany()
                    ...
                    b.HasOne("Surefire.Domain.Shared.Models.Attachment", "WaiverOfSubAttachment")
                        .WithMany()
            ...
            modelBuilder.Entity("Surefire.Domain.Policies.Models.RatingBasis", b =>
                {
                    b.HasOne("Surefire.Domain.Shared.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Surefire.Domain.Shared.Models.Attachment", b =>
                {
                    b.HasOne("Surefire.Domain.Shared.Models.AttachmentGroup", "AttachmentGroup")
                    ...
                    b.HasOne("Surefire.Domain.Shared.Models.Folder", "Folder")
                        .WithMany("Attachments")
